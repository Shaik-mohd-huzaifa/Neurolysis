...
def video_question():
    ...
    questions = [
        "Do you think what the grasshopper did was okay",
        "What did the ants work for and who was singing?",
        "Did ants do the right thing by saving the grasshopper?",
    ]
...
if not st.session_state.started:
    ...
    if st.session_state.question_index < len(QUESTION_TYPES):
        ...
        st.switch_page("pages/4 - Learning Style.py")
